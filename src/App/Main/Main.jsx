        ...
        <main className="main">
            <section>
                <div className="container">
                    <div className="row article flex-row-between" style={{marginTop: '100px'}}><a href="" name="about"></a>
                        <div className="box-cut col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-7"><img
                            src="../assets/Images/home_coffee_pic1.jpg" alt="" className="box-img" /></div>
                        ...
                        <div className="box-cut col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6"><img
                            src="../assets/Images/shome_coffee_pic3.jpg" alt="" className="box-img" /></div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="row">
                        <section className="events flex-row-between">
                            <div className="flex-column-left col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <div className="box box-cut"><img className="box-img" src="../assets/Images/event3.jpg" alt="" />
                            ...
                            <div className="flex-column-left col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <div className="box box-cut"><img className="box-img" src="../assets/Images/event1.jpg" alt="" />
                                    <div className="links-panel flex-row-between">
                                        <a href=""><i className="fas fa-search"></i></a>
                                        <a href=""><i className="fas fa-link"></i></a>
                                    </div>
                            ...
                            <div className="flex-column-left col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <div className="box box-cut"><img className="box-img" src="../assets/Images/event2.jpg" alt="" />
                                    <div className="links-panel flex-row-between">
                                        <a href=""><i className="fas fa-search"></i></a>
                                        <a href=""><i className="fas fa-link"></i></a>
                                    </div>
                            ...
                            <div className="flex-column-left col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <div className="box box-cut"><img className="box-img" src="../assets/Images/event4.jpg" alt="" />
                                    <div className="links-panel flex-row-between">
                                        <a href=""><i className="fas fa-search"></i></a>
                                        <a href=""><i className="fas fa-link"></i></a>
                                    </div>
                            ...
                            <div className="flex-column-left col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <div className="box box-cut"><img className="box-img" src="../assets/Images/event5-meeting.jpg" alt="" />
                                    <div className="links-panel flex-row-between">
                                        <a href=""><i className="fas fa-search"></i></a>
                                        <a href=""><i className="fas fa-link"></i></a>
                                    </div>
                            ...
                            <div className="flex-column-left col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <div className="box box-cut"><img className="box-img" src="../assets/Images/event6-reciepes.jpg" alt="" />
                                    <div className="links-panel flex-row-between">
                                        <a href=""><i className="fas fa-search"></i></a>
                                        <a href=""><i className="fas fa-link"></i></a>
                                    </div>
                            ...
                            <div className="flex-column-left col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <div className="box box-cut"><img className="box-img" src="../assets/Images/event7-reciepes.jpg" alt="" />
                                    <div className="links-panel flex-row-between">
                                        <a href=""><i className="fas fa-search"></i></a>
                                        <a href=""><i className="fas fa-link"></i></a>
                                    </div>
                            ...
                            <div className="flex-column-left col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <div className="box box-cut"><img className="box-img" src="../assets/Images/event7-staff.jpg" alt="" />
                                    <div className="links-panel flex-row-between">
                                        <a href=""><i className="fas fa-search"></i></a>
                                        <a href=""><i className="fas fa-link"></i></a>
                                    </div>
